...
col_names = ['msno', 'song_id', 'target']
als = als[col_names]
train = train[col_names]
valid = valid[col_names]
test = test[col_names]
test_test = test_test[['msno', 'song_id']]
...
pickle.dump(codes_of_user_als, open('codes_of_users_als_train.pickle', 'wb'))
pickle.dump(codes_of_item_als, open('codes_of_songs_als_train.pickle', 'wb'))
pickle.dump(users_factors_als, open('users_factors_als_train.pickle', 'wb'))
pickle.dump(songs_factors_als, open('songs_factors_als_train.pickle', 'wb'))
...
pickle.dump(codes_of_user_als, open('codes_of_users_als_valid.pickle', 'wb'))
pickle.dump(codes_of_item_als, open('codes_of_songs_als_valid.pickle', 'wb'))
pickle.dump(users_factors_als, open('users_factors_als_valid.pickle', 'wb'))
pickle.dump(songs_factors_als, open('songs_factors_als_valid.pickle', 'wb'))
...
pickle.dump(codes_of_user_als, open('codes_of_users_als_test.pickle', 'wb'))
pickle.dump(codes_of_item_als, open('codes_of_songs_als_test.pickle', 'wb'))
pickle.dump(users_factors_als, open('users_factors_als_test.pickle', 'wb'))
pickle.dump(songs_factors_als, open('songs_factors_als_test.pickle', 'wb'))
...
pickle.dump(codes_of_user_als, open('codes_of_users_als_test_test.pickle', 'wb'))
pickle.dump(codes_of_item_als, open('codes_of_songs_als_test_test.pickle', 'wb'))
pickle.dump(users_factors_als, open('users_factors_als_test_test.pickle', 'wb'))
pickle.dump(songs_factors_als, open('songs_factors_als_test_test.pickle', 'wb'))
...
train_new.to_csv('train_with_song_score.csv', index=0)
valid_new.to_csv('valid_with_song_score.csv', index=0)
test_new.to_csv('test_with_song_score.csv', index=0)
test_test_new.to_csv('test_test_with_song_score.csv', index=0)
...
# train_valid_test 0.604135300976
# test 0.59250034293

# new
# train_valid_test 0.604030689203
# test 0.593137815825
